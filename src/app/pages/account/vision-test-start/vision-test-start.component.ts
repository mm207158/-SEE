...
@Component({
  selector: 'app-vision-test-start',
  templateUrl: './vision-test-start.component.html',
  styleUrls: ['./vision-test-start.component.css']
})
export class VisionTestStartComponent implements OnInit {
